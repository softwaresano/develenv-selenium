...
%define chromedriver_version 72.0.3626.69
...
Requires:    ss-develenv-user >= 33 httpd jdk xorg-x11-server-Xvfb libXfont2 libXrandr nx-libs google-chrome-stable firefox
Vendor:      softwaresano
AutoReqProv: no
