...
%define chromedriver_version 112
Name:        selenium
...
Requires:    ss-develenv-user >= 33 httpd java-17-openjdk xorg-x11-server-Xvfb libXfont2 libXrandr nx-libs google-chrome-stable firefox
Vendor:      softwaresano
AutoReqProv: no
